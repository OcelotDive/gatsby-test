          ...
          {Object.keys(companyRating.ratingDetails).map(item => {
            ...
            return (
              <div className={companyStyles.cardInfoBar} key={item}>
                &nbsp;&nbsp;&nbsp;
                <span className={companyStyles.cardDataName}>{item}</span>
                &nbsp;&nbsp;&nbsp;
                ...
                <span className={companyStyles.cardDataInfo}>
                  <small>Rec: </small>
                  <span className={companyStyles.recommendation}>
                    <small>
                      <small>
                        {companyRating.ratingDetails[item].recommendation}
                      </small>
                    </small>
                  </span>
                </span>
