    ...
    return (
        <section className={navStyles.navContainer} ref={ref}>
           ...
           <ul className={navStyles.mainNavList}>
              ...
              <Link style={{textDecoration: "none"}}  to="/mostSearched-page/"><li className={navStyles.mainNavListItem}><span className={navStyles.navListLink} href="#">Most Searched</span></li></Link>
