    ...
    <form className={newsSelect.form} onClick={selectNewsSource}>
      <div className={newsSelect.inputGroup}>
        <input
          ...
          type="radio"
          defaultChecked
          className={newsSelect.radioInput}
        />
        <label htmlFor="radio1" className={newsSelect.radioLabel}>
          Business
        </label>
      </div>
      <div className={newsSelect.inputGroup}>
        <input
          ...
          className={newsSelect.radioInput}
        />
        <label htmlFor="radio2" className={newsSelect.radioLabel}>
          Tech
        </label>
      </div>
      <div className={newsSelect.inputGroup}>
        <input
          ...
          className={newsSelect.radioInput}
        />
        <label htmlFor="radio3" className={newsSelect.radioLabel}>
          Science
        </label>
      </div>
    </form>
